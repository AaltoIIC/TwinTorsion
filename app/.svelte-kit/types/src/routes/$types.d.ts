...
type LayoutRouteId = RouteId | "/" | "/analysis/[id]" | "/component-editor/[[componentId]]" | "/mobile" | "/system-editor/[[systemId]]" | null
type LayoutParams = RouteParams & { id?: string; componentId?: string; systemId?: string }

...
<svelte:head>
    <title>Dashboard | DigiTwin Editor</title>
</svelte:head>
<div class="screen">
    <Header />
        ...
        <div class="resources-cont">
            <div class="title-cont">
                <span class="title">
                    <h2>Resources:</h2>
                    <p class="sub-title">
                        Here you can find the resources to help you get started with DigiTwin Editor.
                    </p>
                </span>
            </div>
            <div class="resources-list">
                <ResourceTile
                    name="User Guide"
                    link="https://github.com/AaltoIIC/DigiTwin-Editor/wiki/User-Guide"
                ...
                <ResourceTile
                    name="Developer Docs"
                    link="https://github.com/AaltoIIC/DigiTwin-Editor/wiki/Developer-Docs"
                ...
                <ResourceTile
                    name="GitHub"
                    link="https://github.com/AaltoIIC/DigiTwin-Editor"
                ...
                <ResourceTile
                    ...
                    description="The DigiTwin editor is developed by Aalto IIC. Our website contains more information about our research."
                    icon={`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.4" stroke="currentColor" class="size-6">
